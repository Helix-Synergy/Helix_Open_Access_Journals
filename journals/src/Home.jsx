  ...
  <ul class="grid grid-cols-1 md:grid-cols-2 gap-6">
    ...
    <li class="flex items-start gap-4 p-4 bg-white rounded-xl shadow-lg hover:shadow-2xl transition-shadow duration-300 group">
      ...
      <div class="flex-shrink-0 w-12 h-12 flex items-center justify-center bg-red-100 text-red-600 rounded-full transform group-hover:scale-110 transition-transform duration-300">
        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5.121 17.804A12.042 12.042 0 0112 15c2.5 0 4.847.78 6.879 2.112M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
        </svg>
      </div>
      <p class="text-gray-700 font-medium text-lg">
...
<div class="flex gap-4 justify-center mt-8">
  {/* <!-- Primary CTA --> */}
  <button class="bg-blue-600 text-white px-6 py-3 rounded-full font-semibold hover:bg-blue-700 transition cursor-pointer">
    Submit Manuscript
  </button>

  {/* <!-- Secondary CTA --> */}
  <button class="border border-blue-600 text-blue-600 px-6 py-3 rounded-full font-semibold hover:bg-blue-50 transition cursor-pointer">
    Explore Journals
  </button>
</div>
